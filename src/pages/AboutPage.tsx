        ...
        <section className="container mx-auto p-2 md:p-5">
            ...
            <article ref={ref} className={`space-y-10 my-5 transition-opacity duration-700 ${inView ? 'opacity-100' : 'opacity-10'}`}>
                <div>
                    ...
                    <p className="als-gorizont text-lg md:text-xl font-medium md:leading-6 text-zinc-400 xl:w-6/12">Профессиональный Frontend-разработчик с душой сноубордиста, любитель абиссинской кошки и настольных игр</p>
                </div>

                <div className='grid grid-cols-1 md:grid-cols-2 justify-start items-start gap-x-4'>
                    <div className="flex items-center justify-center w-full md:order-1">
                        <img
                            src={ImageSelfpresentation}
                            alt=""
                            className="w-full bg-white h-[12rem] xl:h-[24rem] object-cover object-top rounded"
                        />
                    </div>

                    <div className="flex flex-col justify-between h-full w-full md:order-2">
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 justify-start items-start gap-x-4'>
                    ...
                    <div className="flex flex-col justify-between h-full w-full md:order-1">
                        <div className="mx-auto mb-4 text-gray-400 w-full">
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 justify-start items-start gap-x-4'>
                    <div className="flex items-center justify-center w-full md:order-1">
                        <img
                            ...
                            alt=""
                            className="w-full bg-white h-[12rem] xl:h-[24rem] object-cover object-center rounded"
                        />
                    </div>
