      ...
      <div className="xl:hidden flex flex-col items-center mt-4">
        <div
          ...
          <a href="https://github.com/eugenepokalyuk" target="_blank" className="relative">
            <p
              className="text-white ibm-plex absolute top-[50%] -translate-y-[50%] left-[60%] -translate-x-[60%]">GitHub</p>
            <IconGitHub />
          </a>
        </div>
        ...
        <div
          ...
          <a href="https://t.me/PaperCranejs" target="_blank" className="relative">
            <p
              className="text-white ibm-plex absolute top-[50%] -translate-y-[50%] left-[65%] -translate-x-[60%]">Telegram</p>
            <IconTelegram />
          </a>
        </div>
      </div>
