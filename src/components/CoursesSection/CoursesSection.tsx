          ...
          <ul className="mt-4">
            {coursesData.map((courseGroup, idx) => (
              <li key={idx}
                ...
                <h3
                  className="text-[#ffffff3d] text-[16px] italic font-[400] leading-[22px] eb-garamond">{courseGroup.title}</h3>

                <ul>
                  {courseGroup.courses.map((course, courseIdx:number) => (
                    <a href={course.link ? course.link : '#'} key={courseIdx} target="_blank">
                      <li
                        className="text-[#FFD600] text-[16px] italic font-[400] leading-[22px] eb-garamond hover:cursor-pointer hover:underline">{course.name}</li>
                    </a>
                  ))}
                </ul>
              </li>
          ...
          <ul className="mt-4">
            {booksData.map((bookGroup, idx) => (
              <li key={idx}
                  className="grid grid-cols-2 border-b border-[#d9d9d914] pb-4 mb-4 last:border-none last:mb-0 last:pb-0">
                <h3
                  className="text-[#ffffff3d] text-[16px] italic font-[400] leading-[22px] eb-garamond">{bookGroup.title}</h3>
